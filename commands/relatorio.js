...
module.exports = {
  ...
  async execute(interaction) {
    ...
    db.all("SELECT userId, SUM(total) as total FROM pontos GROUP BY userId", [], async (err, rows) => {

      if (err) {
        return interaction.reply({ content: "Erro ao gerar relatório.", ephemeral: true });
      }
